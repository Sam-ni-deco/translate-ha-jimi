  ...
  <n-card hoverable style="margin-bottom: 25px" :size="mode === 'phone' ? 'small' : 'medium'">
    ...
    <n-ul>
      ...
      <n-li>
        ...
        ！
        本网页为NYS部署，采用
        <link-button href="https://dash.cloudflare.com/">
          Cloudflare
        </link-button>
        ！如你也需要部署至Cloudflare
        请使用
        <link-button href="https://github.com/Sam-ni-deco/translate-ha-jimi">
          我的部署版哈吉米开源程序
        </link-button>
      </n-li>
      <n-li>
    ...
    <n-ul>
      ...
      <n-li>
        如果你想聊点什么不太能见光的东西，哈基密语一定是当之无愧的完美工具~
      </n-li>
    </n-ul>
    <n-h3 prefix="bar">
      没有这么高的加密需求？
    ...
    <n-ul>
      <n-li>
        ...
        也可以理解为密钥，但是你需要明文发给对方，如果中间人想看你们聊什么又恰好知道哈吉米翻译这个工具，那就没了）
      </n-li>
    </n-ul>
  </n-card>
</template>
